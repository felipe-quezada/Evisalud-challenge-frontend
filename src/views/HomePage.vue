...
<template>
  <section class="relative bg-bg-mobile bg-cover -z-40 lg:bg-bg-desktop">
    <section
      class="container m-auto grid h-[442px] px-4 pt-[196px] text-2xl text-white font-semibold leading-9 relative -z-10 lg:px-10 md:text-5xl md:h-auto"
    >
    ...
    <section class="bg-black px-4 py-16 text-center text-white text-sm">
      ...
      <section class="h-[250px] py-4 px-5 flex flex-wrap justify-between items-center sm:hidden">
        ...
        <div class="w-[141px] h-[78] flex flex-col py-3 rounded-md bg-black-primary">
          <span class="text-sky-primary font-bold text-xl">14</span>
          <p>Programas de formación</p>
        </div>
        <div
          class="w-[141px] h-[78] flex flex-col py-5 mx-auto rounded-md bg-black-primary sm:mx-0"
        >
  ...
  <section class="bg-black-primary">
    <TeacherProfiles class="container mx-auto" />
  </section>

  <section class="text-white bg-black">
    <div class="flex flex-col items-center justify-center pt-6">
      <h3
        class="mb-10 font-bold relative z-20 after:content-[''] after:bg-sky-primary after:absolute after:h-2 after:w-56 after:left-0 after:ml-1.5 after:bottom-0.5 after:-z-10 after:rounded-full lg:text-4xl lg:after:w-[485px] lg:after:h-3 lg:after:bottom-0 lg:after:ml-7 lg:my-20"
      >
        Cursos que incluye el programa
      </h3>
      <div class="w-full md:flex md:pl-32 md:mb-11 lg:space-x-36">
        <div class="w-full px-4">
          <CardComponent
            number="1"
            course-title="Fundamentos de Conservación Ambiental"
            weeks-time="(2 semanas)"
          />
          <CardComponent
            number="2"
            course-title="Energía Renovable: Fuentes y Aplicaciones"
            weeks-time="(2 semanas)"
          />
          <CardComponent
            number="3"
            course-title="Ecoturismo Responsable y Conservación"
            weeks-time="(3 semanas)"
          />
          <CardComponent
            number="4"
            course-title="Manejo Sostenible de Bosque"
            weeks-time="(5 semanas)"
          />
        </div>
        <div
          class="flex flex-col w-5/6 ml-auto mt-10 mb-20 px-6 py-5 space-y-5 rounded-s-3xl bg-sky-primary text-sm md:my-0"
        >
          <h4 class="font-bold">Inversión</h4>
          <div>
            <strong class="font-bold">$125 (Perú: S/ 420)</strong>
            <span class="block">¡Pregunta por nuestros descuentos!</span>
          </div>
          <ButtonPrimary
